...
public class AbstractProductConfiguration {
	...
	public ProductDtoMusic underPressure() {
		ProductDtoMusic underPressure = new ProductDtoMusic
			...
			"iTunes, Spotify, Amazon Music", "EMI, Elektra", "1981", "English", "Rock, Pop", "Queen, David Bowie", "Hot Space", "4:08");
	...
	public ProductDtoMusic natural() {
		ProductDtoMusic natural = new ProductDtoMusic
			...
			"iTunes, Spotify, Amazon Music", "Kidinakorner, Interscope", "2018", "English", "Rock, Pop", "Imagine Dragons", "Origins", "3:09");
		return natural;
	}
	...
	public ProductDtoMusic withYou() {
		ProductDtoMusic withYou = new ProductDtoMusic
			...
			"iTunes, Spotify, Amazon Music", "Warner Bros", "2000", "English", "Nu metal, Alternative/Indie, Metal", "Linkin Park", "Hybrid Theory", "3:25");
		return withYou;
	}
